...
def main(opt):
  ...
  for epoch in range(start_epoch + 1, opt.num_epochs + 1):
    ...
    writer.add_scalar(os.path.join(opt.save_dir, 'runs/scalar/centernetfromzero70-2'), log_dict_train['loss'], epoch)
    '''
    x = range(0,epoch)
...
if __name__ == '__main__':
  minglingstr = 'ctdet --exp_id fod_centernetfromzero_hg2 --dataset fod --arch hourglass ' \
                '--num_epochs 70 --batch_size 1 --lr 1.25e-4 --lr_step 40,60 '
